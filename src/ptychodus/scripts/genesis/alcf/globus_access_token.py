...
def get_auth_object(force=False):
    ...
    app = globus_sdk.UserApp(
        ...
        config=globus_sdk.GlobusAppConfig(
            request_refresh_tokens=True, token_validation_error_handler=DomainBasedErrorHandler()
        ),
    )
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        'action',
        choices=[AUTHENTICATE_ACTION, GET_ACCESS_TOKEN_ACTION, GET_TOKEN_EXPIRATION_ACTION],
    )
    parser.add_argument(
        '--units',
