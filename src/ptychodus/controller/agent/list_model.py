...
from ...model.agent import ChatRole, ConversationRepository
...
class AgentMessageListModel(QAbstractListModel):
    ...
    def __init__(self, repository: ConversationRepository, parent: QObject | None = None) -> None:
        super().__init__(parent)
        self._repository = repository

    def data(self, index: QModelIndex, role: int = Qt.ItemDataRole.DisplayRole) -> Any:
        if index.isValid():
            message = self._repository[index.row()]
