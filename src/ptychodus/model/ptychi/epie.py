...
class EPIEReconstructor:
    ...
    def _create_probe_options(self, metadata: ProductMetadata) -> PIEProbeOptions:
    ...
    def _create_probe_position_options(self) -> PIEProbePositionOptions:
