...
class AutodiffReconstructor:
    ...
    def _create_probe_options(self, metadata: ProductMetadata) -> AutodiffPtychographyProbeOptions:
    ...
    def _create_probe_position_options(self) -> AutodiffPtychographyProbePositionOptions:
