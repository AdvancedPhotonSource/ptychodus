...
class BHReconstructor:
    ...
    def _create_probe_options(self, metadata: ProductMetadata) -> BHProbeOptions:
    ...
    def _create_probe_position_options(self) -> BHProbePositionOptions:
    ...
    def _create_opr_mode_weight_options(self) -> BHOPRModeWeightsOptions:
