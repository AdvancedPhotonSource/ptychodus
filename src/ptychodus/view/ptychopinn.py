...
class PtychoPINNModelParametersView(QGroupBox):
    ...
    def createInstance(cls, parent: Optional[QWidget] = None) -> PtychoPINNModelParametersView:
        ...
        layout.addWidget(view.probeTrainableCheckBox, 3, 0, 1, 3)
        layout.addWidget(view.intensityScaleTrainableCheckBox, 4, 0, 1, 3)
        layout.addWidget(view.objectBigCheckBox, 5, 0, 1, 3)
        layout.addWidget(view.probeBigCheckBox, 6, 0, 1, 3)
        layout.addWidget(view.probeScaleLabel, 7, 0)
        layout.addWidget(view.probeScaleLineEdit, 7, 1, 1, 2)
        layout.addWidget(view.probeMaskCheckBox, 8, 0, 1, 3)
        layout.addWidget(view.ampActivationLabel, 8, 0)
        layout.addWidget(view.ampActivationLineEdit, 8, 1, 1, 2)
