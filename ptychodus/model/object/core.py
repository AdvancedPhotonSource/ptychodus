...
class ObjectCore:
    ...
    def __init__(self, rng: numpy.random.Generator, settingsRegistry: SettingsRegistry,
        ...
        self._filePlugin = PluginEntry[ObjectInitializer](
            simpleName='FromFile',
            displayName='Open File...',
            strategy=FileObjectInitializer.createInstance(self.settings, self.sizer,
                                                          fileReaderChooser),
        )
        self._uniformPlugin = PluginEntry[ObjectInitializer](
            simpleName='Uniform',
            displayName='Uniform',
            strategy=UniformObjectInitializer.createInstance(self.settings, self.sizer),
        )
        self._urandPlugin = PluginEntry[ObjectInitializer](
            simpleName='Random',
            displayName='Random',
            strategy=UniformRandomObjectInitializer(rng, self.sizer),
        )
        self._initializerChooser = PluginChooser[ObjectInitializer].createFromList(
