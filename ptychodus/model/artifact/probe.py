...
class ProbeRepository(ObservableSequence[ProbeRepositoryItem], ArtifactRepositoryObserver):

    def __init__(self, repository: ArtifactRepository, factory: ProbeBuilderFactory) -> None:
        super().__init__()
