...
class FluorescenceEnhancer:
    ...
    def __init__(self, repository: ProductRepository,
        ...
        # FIXME filetype for file reader/writer choosers
    ...
    def enhanceXRF(self, itemIndex: int) -> None:
        ...
        for channelName, elementMap in self._measured.element_maps.items():
            logger.debug(f'Processing \"{channelName}\"')
            emap_upscaled = upscaler(elementMap, product)
