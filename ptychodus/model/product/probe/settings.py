...
class ProbeSettings(Observable, Observer):
    ...
    def __init__(self, registry: SettingsRegistry) -> None:
        ...
        self.orthogonalizeModesEnabled = BooleanParameter(self._settingsGroup,
        ...
        self.diskDiameterInMeters = RealParameter(self._settingsGroup, "DiskDiameterInMeters",
                                                  1e-6)
        self.rectangleWidthInMeters = RealParameter(self._settingsGroup, "RectangleWidthInMeters",
                                                    1e-6)
        self.rectangleHeightInMeters = RealParameter(self._settingsGroup,
        ...
        self.superGaussianWidthInMeters = RealParameter(self._settingsGroup,
                                                        "SuperGaussianWidthInMeters", 400e-6)
        self.superGaussianOrderParameter = RealParameter(self._settingsGroup,
                                                         "SuperGaussianOrderParameter", 1)

        self.zonePlateDiameterInMeters = RealParameter(self._settingsGroup,
                                                       "ZonePlateDiameterInMeters", 180e-6)
        self.outermostZoneWidthInMeters = RealParameter(self._settingsGroup,
                                                        "OutermostZoneWidthInMeters", 50e-9)
        self.centralBeamstopDiameterInMeters = RealParameter(self._settingsGroup,
                                                             "CentralBeamstopDiameterInMeters",
                                                             60e-6)
        self.defocusDistanceInMeters = RealParameter(self._settingsGroup,
