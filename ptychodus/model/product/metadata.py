...
class MetadataRepositoryItem(ParameterGroup):
    ...
    def __init__(self, parent: UniqueNameFactory, metadata: ProductMetadata) -> None:
        ...
        self.detectorDistanceInMeters = RealParameter(self,
                                                      "detector_distance_m",
                                                      metadata.detectorDistanceInMeters,
                                                      minimum=0.0)
        self.probeEnergyInElectronVolts = RealParameter(self,
                                                        "probe_energy_eV",
                                                        metadata.probeEnergyInElectronVolts,
                                                        minimum=0.0)
        ...
        self.exposureTimeInSeconds = RealParameter(self,
                                                   "exposure_time_s",
