...
class ScanSettings(Observable, Observer):
    ...
    def __init__(self, registry: SettingsRegistry) -> None:
        ...
        self.affineTransformATInMeters = RealParameter(self._settingsGroup,
        ...
        self.affineTransformBTInMeters = RealParameter(self._settingsGroup,
        ...
        self.radialStepSizeInMeters = RealParameter(self._settingsGroup, "RadialStepSizeInMeters",
                                                    1e-6)
        self.numberOfShells = IntegerParameter(self._settingsGroup, "NumberOfShells", 5)
        self.numberOfPointsInFirstShell = IntegerParameter(self._settingsGroup,
        ...
        self.radiusScalarInMeters = RealParameter(self._settingsGroup, "RadiusScalarInMeters",
                                                  0.5e-6)
