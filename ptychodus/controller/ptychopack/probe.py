...
class PtychoPackProbeCorrectionController(Observer):
    def __init__(self, presenter: PtychoPackPresenter, view: PtychoPackProbeCorrectionView) -> None:
        super().__init__()
        ...
        view.pie_beta_slider.valueChanged.connect(presenter.set_pie_beta)
        view.pie_relaxation_slider.valueChanged.connect(presenter.set_pie_probe_relaxation)
