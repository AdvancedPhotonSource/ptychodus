...
class PtychoPINNModelParametersView(QGroupBox):
    ...
    def createInstance(cls, parent: Optional[QWidget] = None) -> PtychoPINNModelParametersView:
        ...
        layout.addWidget(view.intensityScaleTrainableCheckBox, 6, 0, 1, 3)
        layout.addWidget(view.objectBigCheckBox, 7, 0, 1, 3)
        layout.addWidget(view.probeBigCheckBox, 8, 0, 1, 3)
        layout.addWidget(view.probeScaleLabel, 9, 0)
        layout.addWidget(view.probeScaleLineEdit, 9, 1, 1, 2)
        layout.addWidget(view.probeMaskCheckBox, 10, 0, 1, 3)
        layout.addWidget(view.ampActivationLabel, 11, 0)
        layout.addWidget(view.ampActivationLineEdit, 11, 1, 1, 2)
