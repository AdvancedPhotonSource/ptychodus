...
class MetadataValuesGroupBox(QGroupBox):
    ...
    @classmethod
    def createInstance(cls, parent: Optional[QWidget] = None) -> MetadataValuesGroupBox:
        view = cls(parent)
...
class MetadataOptionsGroupBox(QGroupBox):
    ...
    @classmethod
    def createInstance(cls, parent: Optional[QWidget] = None) -> MetadataOptionsGroupBox:
        view = cls(parent)
...
class MetadataDialog(QDialog):
    ...
    def __init__(self, parent: Optional[QWidget]) -> None:
        ...
        self.valuesGroupBox = MetadataValuesGroupBox.createInstance()
        self.optionsGroupBox = MetadataOptionsGroupBox.createInstance()
        self.centerWidget = QWidget()
        self.buttonBox = QDialogButtonBox()

    @classmethod
    def createInstance(cls, parent: Optional[QWidget] = None) -> MetadataDialog:
        view = cls(parent)
