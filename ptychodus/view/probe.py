...
class FluorescenceParametersView(QGroupBox):
    def __init__(self, parent: QWidget | None = None) -> None:
        ...
        self.vspiDampingFactorLineEdit = DecimalLineEdit.createInstance()
        self.vspiMaxIterationsSpinBox = QSpinBox()
        ...
        layout.addRow('VSPI Damping Factor:', self.vspiDampingFactorLineEdit)
        layout.addRow('VSPI Max Iterations:', self.vspiMaxIterationsSpinBox)
